    ...
    <>
      ...
      <main className="min-h-screen bg-earth-100">
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-rust-200 via-earth-100 to-green-100 border-b-4 border-rust-400">
          ...
          {/* Hero Content */}
          <div className="container mx-auto px-2 sm:px-4 relative z-10 flex flex-col items-center justify-center h-full min-h-[40vh]">
            <motion.div
              initial={{ opacity: 0, x: -40 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.7 }}
              className="w-full flex flex-col items-center justify-center pt-20 md:pt-0"
            >
              <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-7xl font-heading text-white drop-shadow-xl tracking-tight mb-4 text-center break-words max-w-full">
                Check Out My Music!
              </h1>
              <p className="text-base xs:text-lg sm:text-xl md:text-2xl font-serif text-white drop-shadow-lg max-w-2xl text-center">
        ...
        <section className="flex items-center justify-center min-h-[75vh] py-8 bg-earth-100 ">
          <div className="container mx-auto px-2 md:px-4">
            ...
            >
              <br /> <br /> <br />
              <h2 className="section-title !text-[56px] !text-black mb-6 font-cursive">Featured Songs</h2>
              <Carousel
                items={[
                  {
